...
// Extend the motor steps range to the encoder steps range
#define MOTOR_STEP_TO_ENCODER_STEP(steps, stepsPerRev, microstepDivisor) ( (steps) * ((POW_2_15) >> (REJECT_ENCODERS_LSB)) / ((stepsPerRev) * (microstepDivisor)) )
